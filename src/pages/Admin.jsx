          ...
          <div className="mb-4">
            <div className="d-flex flex-wrap gap-2">
              {categories.map((category) => (
                <button
                  key={category.id}
                  className={`btn ${activeCategory === category.id ? "btn-dark" : "btn-outline-dark"} rounded-pill`}
          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            {filteredProducts.length > 0 ? (
                  ...
                  <div className="card h-100 shadow-sm border-0 overflow-hidden">
                    <div className="position-relative overflow-hidden" style={{ height: "200px" }}>
                      <img
                        ...
                        alt={product.nombre}
                      />
                      <div className={`position-absolute top-0 start-0 text-white p-2 ${getCategoryColor(product.categoria)}`}>
                        {categories.find((c) => c.id === product.categoria)?.name || product.categoria}
                      </div>
                    ...
                    <div className="card-body d-flex flex-column">
                      ...
                      <div className="mt-auto d-flex justify-content-between">
                        ...
                        <Button variant="danger" size="sm" onClick={() => handleDeleteProduct(product.idproducto)}>
              ...
              <div className="col-12 text-center py-5">
                ...
                <Button variant="primary" className="mt-3" onClick={() => { setSearchTerm(""); setActiveCategory("todos"); }}>
            ...
            <Modal.Body>
              <form onSubmit={handleAddProduct}>
                ...
                <div className="mb-3">
                  ...
                  />
                  {editingProduct && newProduct.foto === null && (
